    ...
    def _get_services(self, group_number, policy):
        ...
        services_a = {
            ...
            1: ['NAMENODE', 'ZKFC', 'JOURNALNODE', 'RESOURCEMANAGER', 'ZOOKEEPER_SERVER', 'HBASE_MASTER', 'DATANODE',
                ...
                'KAFKA_BROKER', 'CELEBORN_MASTER', 'ALLUXIO_MASTER', 'TRINO_COORDINATOR'],
            2: ['ZOOKEEPER_SERVER', 'JOURNALNODE', 'DATANODE', 'NODEMANAGER', 'TIMELINE_READER', 'YARN_REGISTRY_DNS',
                ...
                'INFRA_SOLR', 'KYUUBI_SERVER', 'CELEBORN_WORKER', 'ALLUXIO_WORKER', 'RANGER_KMS_SERVER', 'TRINO_WORKER','HADOOP_ROUTER']
        }
        services_b = {
            ...
            1: ['APP_TIMELINE_SERVER', 'RANGER_ADMIN', 'METRICS_GRAFANA', 'ZOOKEEPER_SERVER', 'DATANODE', 'NODEMANAGER',
                ...
                'SPARK_THRIFTSERVER', 'HISTORYSERVER', 'RANGER_USERSYNC', 'ALLUXIO_MASTER', 'CELEBORN_MASTER', 'TRINO_COORDINATOR','HADOOP_ROUTER'],
            2: ['AMBARI_SERVER', 'TIMELINE_READER', 'YARN_REGISTRY_DNS', 'METRICS_COLLECTOR', 'HBASE_REGIONSERVER',
                'DATANODE', 'NODEMANAGER', 'WEBHCAT_SERVER', 'KAFKA_BROKER', 'FLINK_HISTORYSERVER','TRINO_WORKER',
                'RANGER_TAGSYNC', 'CELEBORN_WORKER', 'ALLUXIO_WORKER', 'KNOX_GATEWAY', 'RANGER_KMS_SERVER'],
